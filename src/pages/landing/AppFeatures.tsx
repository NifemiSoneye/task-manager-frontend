const AppFeatures = () => {
  return (
    <div className="h-full mt-10 px-4 md:flex flex-col  lg:mx-60">
      <p className="text-[#C9A84C] uppercase text-xs mb-4 md:text-left">
        Why Taskflow
      </p>
      <p className="text-2xl mb-14 text-white font-['Playfair_Display_Variable'] md:text-[3vw] font-bold">
        Everything you need, <br /> nothing you don't.
      </p>
      <div className="md:flex md:items-center justify-center">
        <section className="grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-6">
          <div className="bg-[#132040] p-4 rounded-md md:max-w-[20vw] md:p-6">
