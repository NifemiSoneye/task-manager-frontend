    ...
    <>
      ...
      <aside
        className={`
          ...
          transition-transform duration-300 min-h-screen flex flex-col justify-between
      ...
      >
        ...
        <div className="p-6 border-t border-t-[#292c33] text-white uppercase text-sm font-semibold flex items-center gap-3  ">
          <div className="w-8 h-8 flex items-center justify-center rounded-full bg-[linear-gradient(135deg,#C9A84C,#1E3160)] text-black font-semibold shrink-0">
